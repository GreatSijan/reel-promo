// DuxiosPromoEN.tsx — Duxios Promo Reel (English)
...
function SceneIntro({ frame }: { frame: number }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0a0a", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "0 80px" }}>
      ...
      <div style={{ opacity: tagIn, fontSize: 24, letterSpacing: "0.28em", color: "rgba(255,255,255,0.35)", fontFamily: "Arial, sans-serif", textTransform: "uppercase", marginBottom: 36 }}>— digital agency —</div>
      <div style={{ opacity: h1In, transform: `scale(${scale1})`, fontSize: 120, fontWeight: 900, color: "#fff", lineHeight: 1.0, fontFamily: "Arial, sans-serif", letterSpacing: "-0.03em", marginBottom: 6 }}>duxios</div>
      <div style={{ opacity: h2In, transform: `scale(${scale2})`, fontSize: 52, fontWeight: 400, color: "rgba(255,255,255,0.6)", lineHeight: 1.0, fontFamily: "Arial, sans-serif", letterSpacing: "0.02em", marginBottom: 50 }}>We build digital experiences</div>
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0a0a", fontFamily: "Arial, sans-serif" }}>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 80px" }}>
        ...
        <div style={{ opacity: titleIn, transform: `translateY(${(1-titleIn)*40}px)`, fontSize: 82, fontWeight: 900, color: "#fff", lineHeight: 1.0, letterSpacing: "-0.02em", marginBottom: 22 }}>Website<br />Development.</div>
        <div style={{ opacity: descIn, fontSize: 26, color: "rgba(255,255,255,0.5)", lineHeight: 1.6, maxWidth: 680, marginBottom: 44 }}>High-performance, responsive websites built with cutting-edge technology.</div>
        {["Fast and optimised for results", "Modern design tailored to your brand", "SEO optimisation included"].map((f, i) => {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0a0a", fontFamily: "Arial, sans-serif" }}>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 80px" }}>
        ...
        <div style={{ opacity: titleIn, transform: `translateY(${(1-titleIn)*40}px)`, fontSize: 82, fontWeight: 900, color: "#fff", lineHeight: 1.0, letterSpacing: "-0.02em", marginBottom: 22 }}>Branding<br />& Identity.</div>
        <div style={{ opacity: descIn, fontSize: 26, color: "rgba(255,255,255,0.5)", lineHeight: 1.6, maxWidth: 680, marginBottom: 44 }}>Distinctive visual systems that capture the essence of your brand.</div>
        {["Logo and visual identity", "Brand guidelines and strategy", "Complete branding from scratch"].map((f, i) => {
          const eachIn = [feat1In, feat2In, feat3In][i];
          return (
            <div key={i} style={{ opacity: eachIn, transform: `translateX(${(1-eachIn)*30}px)`, display: "flex", alignItems: "center", gap: 18, marginBottom: 16 }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#fff", flexShrink: 0 }} />
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0a0a", fontFamily: "Arial, sans-serif" }}>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 80px" }}>
        ...
        <div style={{ opacity: titleIn, transform: `translateY(${(1-titleIn)*40}px)`, fontSize: 82, fontWeight: 900, color: "#fff", lineHeight: 1.0, letterSpacing: "-0.02em", marginBottom: 22 }}>Social Media<br />Marketing.</div>
        <div style={{ opacity: descIn, fontSize: 26, color: "rgba(255,255,255,0.5)", lineHeight: 1.6, maxWidth: 680, marginBottom: 44 }}>Strategic campaigns that grow your audience and drive real engagement.</div>
        {["Instagram, TikTok, LinkedIn", "Content that converts", "Measurable results"].map((f, i) => {
          const eachIn = [feat1In, feat2In, feat3In][i];
          return (
            <div key={i} style={{ opacity: eachIn, transform: `translateX(${(1-eachIn)*30}px)`, display: "flex", alignItems: "center", gap: 18, marginBottom: 16 }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#fff", flexShrink: 0 }} />
...
function SceneCTA({ frame }: { frame: number }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "#0a0a0a", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "0 80px", opacity: bgIn }}>
      ...
      <div style={{ opacity: h1In, transform: `scale(${0.92 + h1In * 0.08})`, fontSize: 108, fontWeight: 900, color: "#fff", fontFamily: "Arial, sans-serif", letterSpacing: "-0.03em", lineHeight: 1.0, marginBottom: 10 }}>Your turn.</div>
      <div style={{ opacity: h2In, fontSize: 34, fontWeight: 400, color: "rgba(255,255,255,0.5)", fontFamily: "Arial, sans-serif", lineHeight: 1.5, marginBottom: 55, maxWidth: 700 }}>We build digital experiences that act fast.</div>
      <div style={{ opacity: ctaIn, transform: `scale(${0.94 + ctaIn * 0.06})`, border: "1.5px solid rgba(255,255,255,0.5)", color: "#fff", fontSize: 34, fontWeight: 700, fontFamily: "Arial, sans-serif", padding: "22px 72px", borderRadius: 100, letterSpacing: "0.04em", boxShadow: `0 0 ${30 + pulse * 50}px rgba(255,255,255,${0.05 + pulse * 0.1})` }}>
        Get in touch →
      </div>
      <div style={{ opacity: subIn, marginTop: 28, fontSize: 22, color: "rgba(255,255,255,0.3)", fontFamily: "Arial, sans-serif", letterSpacing: "0.12em" }}>duxios.com</div>
    </div>
  );
}

export const DuxiosPromoEN: React.FC = () => {
